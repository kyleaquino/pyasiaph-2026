...
from pyasiaph.presentations.models import Schedule
from pyasiaph.sponsors.models import Sponsor, SponsorType
...
class HomePage(Page):
    ...
    def keynote_speakers(self):
        ...
        service = PretalxService(base_url=base_url, api_token=api_token)
        speakers = []
        try:
    ...
    def sponsor_types(self):
        return (
            SponsorType.objects.annotate(sponsor_count=Count("sponsors"))
            .filter(
